...
public class apear : MonoBehaviour {
	...
	void Start () {
        ...
        killme = ("This is John. " + "  \r\n" + "John has just got a job as a Security manager at one of those rich person houses. Unfortunately for him, it's a zombie apocalypse at the moment, so he got a lot to do. " + "  \r\n" + "  \r\n" + "The guard wall used to have three canons but now they upgraded to four weirdly they forgot to upgrade the power outlets so there are one too few. He is running out of space to put the power cords." + "  \r\n" + "  \r\n" + hangme + "  \r\n" + "  \r\n" + shootme);
    }
